      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
        <ScrollView>
          <View style={styles.container}>
            <Image
              source={{
                uri: "https://res.cloudinary.com/drda29q8x/image/upload/v1675982251/Jam%20images/tobiloba_a_group_of_young_and_modern_music_lovers_who_are_also__b9b7e963-db67-46d2-a901-b537315aa377_1_pjgf0s.png",
              }}
              alt="banner"
              style={styles.banner}
            ></Image>
